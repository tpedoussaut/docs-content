...
excerpt: |
  This will show you how configure IoT Hub routes.
totalTime: PT30M
categories:
  - iot-hub
brands:
...
The documentation is there: [IoT Hub Routes](/iot/iot-hub/reference-content/routes/)
...
3. An object iot/messages/hello/world should now be stored in your bucket with "hello world" as contents.
	Retrieve the object using `s3cmd`:
...
In PostgreSQL, the `topic` database field **must** be a of _text_ type, and `payload` a _bytea_.
...
More examples including MySQL and more advanced features are available on the [database route tips & tricks](/iot/iot-hub/api-cli/cli-db-tips-tricks/) page.
...
<Navigation title="See Also">
  ...
  <NextButton to="/iot/iot-hub/api-cli/cli-db-tips-tricks/">Discovering IoT Hub Database Route Tips & Tricks</NextButton>
</Navigation>
