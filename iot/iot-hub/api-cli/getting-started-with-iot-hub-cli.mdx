...
excerpt: |
  In this tutorial we will use the API through the Scaleway command line interface (CLI). This will show you how to create Hubs and Devices, as well as the more advanced features of the Scaleway Elements IoT Hub: Hub Events and Routes.
totalTime: PT30M
categories: 
  - iot-hub
...
In this tutorial we will use the API through the Scaleway command line interface [CLI](https://github.com/scaleway/scaleway-cli#Installation). This will show you how to create Hubs and Devices, as well as more advanced features of the Scaleway Elements IoT Hub: Hub Events and Routes.
...
You can harness the real power of MQTT Pub/Sub with [a few more lines of reading](https://blog.scaleway.com/introduction-to-mqtt-protocol/).
