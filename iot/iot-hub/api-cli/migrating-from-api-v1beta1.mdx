...
description: This page describes the steps required to migrate to the new IoT Hub API version.
image: /assets/images/docs/scaleway.png
excerpt: |
  This document will guid you through the breaking changes introduced by the v1 API.
totalTime: PT10M
steps:
...
brands: 
  - elements
keywords: cloud documentations, iot, iot hub, migration, guide, v1
---

<Message type="important">

To ensure that consumers of the `v1beta1` API version have enough time to migrate, this version will remain online until **November 30th 2021**.
...
To have a consistent experience across Scaleway elements products, a common metrics format has been adopted. The changes are:
