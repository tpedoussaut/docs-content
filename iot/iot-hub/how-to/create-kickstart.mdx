...
excerpt: |
  This page explains how to create an IoT Kickstart
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: IoT, Kickstart, create, Howto
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/connect-twins-to-grafana-cloud/">How to connect IoT Cloud Twins to Grafana Cloud</PreviousButton>
