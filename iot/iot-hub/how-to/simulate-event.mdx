...
excerpt: |
  This page explains how to generate an error and receive an event.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
For more information on Hub Events, you can read the [IoT Hub events documentation](/iot/iot-hub/reference-content/hubs/#events).
