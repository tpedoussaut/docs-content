...
excerpt: |
  This page explains how to understand event messages.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/understand-event-messages/
image: /assets/images/docs/scaleway.png
keywords: IoT, metrics, create, Howto
dates:
...
- `service level: message payload is too large`: See [limits](/iot/iot-hub/reference-content/hubs/#limits-and-quotas) for the maximum allowed messages payload size.
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/simulate-event/">How to simulate events</PreviousButton>
  <NextButton to="/iot/iot-hub/how-to/trigger-functions-from-messages/">How to trigger functions from IoT Hub messages</NextButton>
</Navigation>
