...
excerpt: |
  IoT Hub and Serverless Function as a Service are excellent at teaming up together to execute code to react in real-time to messages from IoT Devices. Here is how to do it.
totalTime: PT30M
image: /assets/images/docs/scaleway.png
keywords: iot, serverless, faas, automation, rest
categories: 
  - iot-hub
brands: 
  - elements
