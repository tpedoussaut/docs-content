...
excerpt: |
  This page explains how to view metrics.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/view-metrics/
...
<Lightbox src="assets/scaleway-iothub_metrics_menu.png" alt="" />

The metrics of the Hub are visualized as graph:

<Lightbox src="assets/scaleway-iothub_metrics_hub.png" alt="" />
...
<Lightbox src="assets/scaleway-iothub_metrics_menu_device.png" alt="" />

4. Click the device name to open the **Device Information** view, which includes a device metrics section.
<Lightbox src="assets/scaleway-iothub_metrics_device.png" alt="" />
