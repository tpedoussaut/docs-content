...
excerpt: |
  This page explains how to delete an IoT Hub device.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/delete-device
...
4. Confirm the deletion of the device by clicking **Delete this device**.
...
<Navigation title="See Also">
  ...
  <NextButton to="/iot/iot-hub/how-to/delete-hub/">How to delete a Hub</NextButton>
</Navigation>
